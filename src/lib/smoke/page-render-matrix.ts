...
export const PAGE_RENDER_MATRIX: readonly PageRenderExpectation[] = [
  ...
  {
    route: '/pokemon/venusaur',
    sourceGroup: 'pokemon',
    bodyMustContain: [
      'Venusaur',
      '#0003',
      'Gameplay & Visuals',
      'Species Riding profile',
      'Riding Details',
      'cobblemon:land/horse',
      'Profile #7 horse',
      'canJump Yes',
      'speedExpr ride_stat LAND SPEED 0.1-1.2 x1',
      'Seat 1',
      'Pose STAND x -0.011616215 y -1.3666525 z -0.28912854',
    ],
  },
  {
    ...
    bodyMustContain: [
      ...
      'AIR',
      'cobblemon:air/bird',
      'cobblemon:ride.loop.wind.stereo',
      'volume ride_velocity_squared',
      'pitch ride_velocity_pitch_curve',
      'Muffled',
      'Passengers only',
      'LAND',
      'cobblemon:land/horse',
