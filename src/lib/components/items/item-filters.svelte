<script lang="ts">
  ...
  const filteredTags = $derived(
    tagSearch ? tags.filter((t) => t.name.toLowerCase().includes(tagSearch.toLowerCase())) : tags,
  );
    ...
    <div class="flex flex-wrap gap-2 pb-4 pt-2">
      ...
      <DropdownMenu.Root>
        ...
        <DropdownMenu.Content class="w-56">
          <div class="p-2">
            <Input type="search" placeholder="Search tags..." class="h-8" bind:value={tagSearch} />
          </div>
